	...
	<div class="header-primary">
		...
		<!-- 	<div class="nav-primary-container" role="navigation">
                <div class="container">
                    <ul class="nav-primary nav-horizontal" role="navigation">
                        <li><a class="small" href="/">&nbsp;</a></li>
                            <li><a href="/student/createGroup" target="" data-nav="createGroup" class="">Create Group</a></li>
                            <li><a href="/student/joinGroup" target="" data-nav="manageGroup" class="">Join Group</a></li>
  							<li><a href="/student/leaveGroup" target="" data-nav="leaveGroup" class="">Leave Group</a></li>
  							<li><a href="/student/deleteGroup" target="" data-nav="deleteGroup" class="">Delete Group</a></li>
  							<li><a href="/student/viewGroup" target="" data-nav="viewGroup" class="">View Group</a></li>
                            </ul>
                </div>
	</div>  -->
