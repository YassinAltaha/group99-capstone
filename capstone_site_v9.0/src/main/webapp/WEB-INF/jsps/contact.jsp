	...
	<!-- View-dependent nav area -->
		...
		<div class="container" align="center">
			<div class="wrapper block-row" >
				<div align="center" class="large-text callout-with-stats welcome" style="height: 458px;">
 
   					
   					 <div class="inner-wrapper title-block-wrapper"><h2>Contact Sheridan Research</h2></div>
