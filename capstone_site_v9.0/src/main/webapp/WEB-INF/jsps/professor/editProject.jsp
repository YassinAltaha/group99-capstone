...
<title>Manage the Project Status & Notes</title>
</head>
<body>
	...
	<div class="message-highlight" align="center">
		<h2>Update the Project Status & Notes</h2>
		<c:url var="url" value="/professor/updateProject" />
		<form:form action="${url}" modelAttribute="project" method="POST">
			...
			<p>
				...
				<form:select path="status" items="${project.statusList}" /><br /></label>
			</p>
			<p>
				<label for="profNote">Professor Notes: &nbsp;<form:input
						path="profNote" /><br /></label>
			</p>
