		...
		<div class="wrapper block-row">
			<div align="center"
				...
				<div class="inner-wrapper">
					...
					<ul>
						<li>Develop a working final system using 5 development
							iterations</li>
						<li>Test the final system</li>
						<li>Deploy the final system</li>
						<li>Demonstrate and/or present the system to the Capstone
							faculty at the completion of each development iteration</li>
						<li>Hopefully learn a lot, have lots of fun and deliver a
							great product!</li>
					</ul>
				</div>
